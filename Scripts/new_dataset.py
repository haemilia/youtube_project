...
def dataset_construction():
    ## Concatenate popular video dataframes
    ## Concatenate channel dataframes
    ## Calculate potential range by channel
    ## Request for uploads playlist items by channel
    ## Filter uploads playlist items
    ## Request for unpopular video information
    ########## continue from here
    ...
    ## Back up tabular data
    ## Load Feature Extraction model
    ## Extract title_features
    ## Download thumbnails
    ## Extract thumbnail_features
    ## Download videos
